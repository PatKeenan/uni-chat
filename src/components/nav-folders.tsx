...
import { ChevronRight, FolderOpen, MessageSquare, Pin, MoreHorizontal, Trash2 } from "lucide-react";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
  ...
  return (
    <SidebarMenuSubItem key={chat.id}>
      <div className="group/chat-item relative flex items-center w-full">
        <SidebarMenuSubButton asChild isActive={isActive} className="flex-1 pr-8">
