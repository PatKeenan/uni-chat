...
export function createMockUser(overrides?: Partial<typeof user.$inferSelect>): typeof user.$inferSelect {
  return {
    id: nanoid(),
...
export function createMockSession(overrides?: Partial<typeof session.$inferSelect>): typeof session.$inferSelect {
  return {
    id: nanoid(),
    userId: nanoid(),
