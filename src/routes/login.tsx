  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse at 30% 20%, rgba(196, 112, 75, 0.06) 0%, transparent 50%),
            radial-gradient(ellipse at 70% 80%, rgba(196, 112, 75, 0.04) 0%, transparent 40%)
          `,
        }}
      />
      ...
      <div className="w-full max-w-[36rem] relative z-10">
        ...
        <div className="absolute -top-20 -left-16 w-32 h-32 orb orb-primary animate-float float-delay-1 opacity-60" />
        <div className="absolute -top-8 -right-12 w-20 h-20 orb orb-secondary animate-float float-delay-2 opacity-50" />
        <div className="absolute -bottom-12 -left-8 w-16 h-16 orb orb-tertiary animate-float float-delay-3 opacity-70" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2 animate-fade-slide-up delay-200">
              ...
              <Input
                ...
                required
                disabled={isLoading}
                className="h-12 rounded-xl border-border bg-background focus:ring-2 focus:ring-warm-500/20 focus:border-warm-400 transition-all"
              />
            </div>
            ...
            <div className="pt-2 animate-fade-slide-up delay-300">
              <Button
                type="submit"
            ...
            <div className="text-center pt-2 animate-fade-slide-up delay-350">
